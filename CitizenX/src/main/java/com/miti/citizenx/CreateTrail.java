...
public class CreateTrail extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
            ...
            window.setStatusBarColor(getResources().getColor(R.color.grey_trailblaze));
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        getMenuInflater().inflate(R.menu.menu_create_trail, menu);
        return true;
    }
